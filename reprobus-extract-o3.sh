...
function help() {
    ...
    echo "###                     / / / / / /       "
    echo "###"
    echo "### ${bold}${SCRIPT_NAME}${normal} script handles the ECMWF o3 extraction for the REPROBUS simulations."
    echo "### The user have to define the start date of the data extraction and the paths"
